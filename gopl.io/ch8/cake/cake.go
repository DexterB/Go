// Package cake provides a simulation of a concurrent cake shop with numerous
// parameters.
//
// The benchmark is run using the following parameters:
...
type Shop struct {
	Verbose             bool
	Cakes               int             // The number of cakes to bake.
 ...
 * distributed around the duration, d, with a standard deviation of stddev.
 */
